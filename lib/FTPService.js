...
/*
First get current local backup files to avoid duplicates
 */
...
/*
Adapt local folder structure to remote folder structure
 */
const adaptLocalStructure = (path) => {
    fs.readdir(`${process.env.LOCAL_PATH}${path}`, (err) => {
        if (err) {
